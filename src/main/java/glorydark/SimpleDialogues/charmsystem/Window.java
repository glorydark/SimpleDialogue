...
public class Window {
    ...
    public static void showDialogueClearBonusMenu(Player player, Dialogue dialogue){
        if(player != null && player.isOnline()){
            ...
            StringBuilder showMsgBuilder = new StringBuilder("恭喜您完成了对话:" + dialogue.getDialogueName() + ",获得了" + TextFormat.LIGHT_PURPLE + "魅力值*" + dialogue.getCharmPoint() + TextFormat.WHITE);
